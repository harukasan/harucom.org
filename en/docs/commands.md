...
| [`zoom`](../settings/#zooming-the-screen) | Change the text size on screen <span class="badge-v2">New in 2.0</span> |
| [`picorabbit`](../picorabbit/) | Show slides |
| [`johakyu`](../johakyu/) | Live code sound and light <span class="badge-v2">New in 2.0</span> |

IRB itself provides a few commands.

| Command | Description |
|---------|-------------|
| `jobs` | Show whether an app is suspended <span class="badge-v2">New in 2.0</span> |
| `fg` | Resume the suspended app <span class="badge-v2">New in 2.0</span> |
...
<kbd><kbd>Ctrl</kbd>-<kbd>Z</kbd></kbd> while it runs. Typing `fg` picks it up where it left off. <span class="badge-v2">New in 2.0</span>
