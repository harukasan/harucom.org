...
It wraps [DVI::Graphics](../dvi/) and provides an easy-to-use API for fill and stroke colors,
...
- [Drawing Text](#drawing-text)
  - [P5#text_font](#p5text_fontfont-wide_font--nil)
  - [P5#text_color](#p5text_colorcolor)
  - [P5#text_align](#p5text_alignhorizontal-vertical--top)
